                ...
                <div class="col-lg-12">
                    ...
                    <div class="featured__controls">
                        <ul>
                            ...
                            <li data-filter=".oranges">Category 1</li>
                            <li data-filter=".fresh-meat">Category 2</li>
                            <li data-filter=".vegetables">Category 3</li>
                            <li data-filter=".fastfood">Category 4</li>
                        </ul>
                    </div>
                </div>
            </div>
