...
<head>
    ...
    <!-- Google Font -->
    {{ Html::style(asset('https://fonts.googleapis.com/css2?family=Cairo:wght@200;300;400;600;900&display=swap')) }}

    <!-- Css Styles -->
    {{ Html::style(asset('assets/css/bootstrap.min.css')) }}
    {{ Html::style(asset('assets/css/font-awesome.min.css')) }}
    {{ Html::style(asset('assets/css/elegant-icons.css')) }}
    {{ Html::style(asset('assets/css/nice-select.css')) }}
    {{ Html::style(asset('assets/css/jquery-ui.min.css')) }}
    {{ Html::style(asset('assets/css/owl.carousel.min.css')) }}
    {{ Html::style(asset('assets/css/slicknav.min.css')) }}
...
<body>
    ...
    <!-- Js Plugins -->
    {{ Html::script(asset('assets/js/jquery-3.3.1.min.js')) }}
    {{ Html::script(asset('assets/js/bootstrap.min.js')) }}
    {{ Html::script(asset('assets/js/jquery.nice-select.min.js')) }}
    {{ Html::script(asset('assets/js/jquery-ui.min.js')) }}
    {{ Html::script(asset('assets/js/jquery.slicknav.js')) }}
